...
//creating class student to store attributes
class Student
{
private:
    int rollno;
...
//function to acceot rollno,name and marks
void Student::accept()
{
...
//function to return rollno of student
int Student::getrno()
{
    return rollno;
}
...
int main()
{
    ...
    while (1)
    {
        //choice of operations available for users
